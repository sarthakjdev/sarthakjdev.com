			...
			{!status && (
				<div className="relative w-full rounded-full bg-white p-2 dark:bg-neutral-950">
					<input
						...
						className="left-3 top-3 w-full rounded-full p-3 text-base text-black outline-none focus:outline-primary-600 dark:bg-neutral-950 dark:text-neutral-50 dark:focus:outline-primary-500"
					/>
					<button
