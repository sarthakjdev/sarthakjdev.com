...
export default function Signup(){
    ...
    return (
        ...
        <form  className="flex flex-col w-20rem gap-24" onSubmit={formik.handleSubmit}>
            ...
            <button type="submit" className="uppercase bg-primary text-white border-primary border-2 hover: hover:bg-transparent w-fit m-auto my-6 px-10 font-extrabold py-2 rounded-3xl">Signup</button>
        </form>
    </section>
    )
}