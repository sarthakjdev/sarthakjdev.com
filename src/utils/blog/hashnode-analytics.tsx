...
export const Analytics = () => {
	...
	const post = useBlogStore(state => state.post)
	...
	useEffect(() => {
		...
		_sendViewsToHashnodeInternalAnalytics().catch(error => console.error(error))
		_sendViewsToHashnodeAnalyticsDashboard().catch(error => console.error(error))
	}, [post, publication.id, publication.integrations?.umamiWebsiteUUID])
